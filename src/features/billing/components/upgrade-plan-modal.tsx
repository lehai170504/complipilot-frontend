...
export function UpgradePlanModal({
  ...
  async function handlePlanAction(plan: SubscriptionPlan) {
    ...
    if (plan === "ENTERPRISE") {
      window.location.href = "mailto:sales@complipilot.com?subject=Enterprise Plan Inquiry";
      return;
    }
    ...
    if (!isUpgrade(currentPlan, plan)) {
      try {
        ...
        const response = await createCustomerPortalSession(organizationId);
              ...
              return (
                ...
                >
                  ...
                  <CardContent className="flex h-full flex-col p-5 sm:p-6">
                    ...
                    >
                      {checkoutMutation.isPending || isHandlingAction ? (
